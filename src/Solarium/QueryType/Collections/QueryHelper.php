...
class QueryHelper {
    ...
    static function execute(Client $client, Query $query, $endpoint = null) {
     ...
     */
    static function registerCollectionsAPI(Client $client) {
     ...
     */
    static function getQueryStatusQuery(Client $client) {
